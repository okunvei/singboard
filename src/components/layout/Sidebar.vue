  ...
  <div class="flex flex-col w-48 bg-base-200 border-r border-base-300 h-full">
    ...
    <div class="mb-0.5 px-4 pt-2.5 pb-2 border-t border-base-300 flex justify-center">
      <button
        ...
        :class="isRunning ? 'btn-ghost bg-primary/10 text-primary hover:bg-primary/20 hover:text-primary' : 'btn-ghost !bg-base-300/40 !text-base-content/20 cursor-not-allowed'"
      >
    ...
    <div class="px-4 py-1.5 pt-2.5 border-t border-base-300 space-y-3">
      ...
      <div class="flex flex-col gap-1">
        <button 
          class="btn btn-sm btn-ghost w-full justify-start font-normal hover:bg-success/10 hover:text-success text-base-content/80 disabled:!bg-base-300/50 disabled:!text-base-content/30"
        ...
        <button 
          class="btn btn-sm btn-ghost w-full justify-start font-normal hover:bg-warning/10 hover:text-warning text-base-content/80 disabled:!bg-base-300/50 disabled:!text-base-content/30"
        ...
        <button 
          class="btn btn-sm btn-ghost w-full justify-start font-normal hover:bg-error/10 hover:text-error text-base-content/80 disabled:!bg-base-300/50 disabled:!text-base-content/30"
